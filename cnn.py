...
class Propuesta_1_RC:
    ...
    def CrearModelo(self):
        ...
        # Creación del modelo
        self.model = Sequential()
        self.model.add(Conv2D(32, (3, 3), activation='relu', input_shape=(28, 28, 2)))
        self.model.add(BatchNormalization())
        self.model.add(MaxPooling2D((2, 2)))
        self.model.add(Dropout(0.2))
...
class Propuesta_2_RC:
    ...
    def CrearModelo(self):
        ...
        # Creación del modelo
        self.model = Sequential()
        self.model.add(Conv2D(32, (3, 3), activation='sigmoid', input_shape=(28, 28, 2)))
        self.model.add(BatchNormalization())
        self.model.add(MaxPooling2D((2, 2)))
        self.model.add(Dropout(0.2))
...
class Propuesta_3_RC:
    ...
    def CrearModelo(self):
        ...
        # Creación del modelo
        self.model = Sequential()
        self.model.add(Conv2D(32, (3, 3), activation='elu', input_shape=(28, 28, 2)))
        self.model.add(BatchNormalization())
        self.model.add(MaxPooling2D((2, 2)))
        self.model.add(Dropout(0.2))
...
class Propuesta_4_RC:
    ...
    def CrearModelo(self):
        ...
        # Creación del modelo
        self.model = Sequential()
        self.model.add(Conv2D(32, (3, 3), activation='tanh', input_shape=(28, 28, 2)))
        self.model.add(BatchNormalization())
        self.model.add(MaxPooling2D((2, 2)))
        self.model.add(Dropout(0.2))
...
class RedNeuronal:
    ...
    def Predecir(self, nuevasImgs):
        ...
        for p1, p3, p4 in zip(prop_1, prop_3, prop_4):
            valores, cuentas = np.unique([p1, p3, p4], return_counts=True)
